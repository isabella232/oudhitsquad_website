...
//
$_CONFIG['main_title'] = "OUDHS Files";
...
/* General styles */
 ...
 body{
	...
	font-size: 13px;
	text-align:center;
	background:url(../images/tech7.png) #000 top fixed;
	color:#fff;
...
?>
<title>Official Unloved Device HitSquad</title>
...
<body class="<?php print ($this->mobile == true?"mobile":"standard");?>">
 ...
 <div class="container">
    ...
    <h1 class="fontface" id="title"><a href="../index.php"><span class="green">OUDHS</span></a></h1>
